        ...
        >
          ...
          <tbody>
            {order.map((v, i) => {
              return (
                <tr key={v.id}>
                  <td className="text-center align-middle">{v.camp} </td>
                  <td className="text-center align-middle">{v.campzone} </td>
                  <td className="text-center align-middle">{v.price}</td>
                  ...
                  <td className="text-center align-middle">{v.orderTotal}</td>
                  <td className="text-center align-middle">
                    <button
                      type="button"
                      className="btn btn-light"
              ...
              <tr key={v.id}>
                <td colSpan="7">
                  ...
                  <div className="row">
                    ...
                    <div className="col-4 mt-2">NT ${v.price}</div>
                  </div>
                </td>
              </tr>
            ))}
