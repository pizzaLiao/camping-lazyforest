  ...
  if (
      ...
      <div>
        <div className={`${styles.nav} d-none d-md-flex`}>
          ...
          <ul className={`${styles.centeredUl} ${styles.mobileMenu}`}>
            ...
            <Link href="/member-dashboard/my-map">
              <li>
                <button className={`${styles.shoppingBtn}`}>
                  <p className={`${styles.shopping}`}>MY CAMPING MAP</p>
                  <p className={`${styles.sale}`}>我的露營地圖</p>
                </button>
              </li>
            </Link>
            ...
            <Link href="/member-dashboard/order-record">
              <li>
                <button className={`${styles.communicateBtn}`}>
                  <p className={`${styles.communicate1}`}>ODER LIST</p>
            ...
            <Link href="/member-dashboard/voucher">
              <li>
                <button className={`${styles.communicateBtn}`}>
                  <p className={`${styles.communicate1}`}>COUPON</p>
          ...
          <div className={`${styles.journey} mt-5`}>
            ...
            <Link href="/testcart" className={`${styles.journeyL} d-flex`}>
    ...
    asideContent = (
      <div className={`${styles.nav} d-none d-md-flex`}>
        ...
        {/* 會員中心 */}
        <Link href="/member-dashboard" className={styles.customLink}>
        ...
        <Link className="btn btn-dark" href="/member-dashboard/my-map">
          我的地圖
        </Link>
        <Link className="btn btn-dark" href="/member-dashboard/order-record">
          訂單紀錄
        </Link>
        <Link className="btn btn-dark" href="/member-dashboard/posts">
          我發的文
        </Link>
      </div>
    )
      ...
      <div className={`${styles.phoneNav} d-block d-md-none container p-0`}>
        <div className={`${styles.headLazy}`}>
          ...
          <div className={`${styles.icons} d-flex`}>
            <Link href="/member-dashboard">
              <FiUser className={`${styles.fiUser} mt-5 `} />
            </Link>
            {/* 購物車 */}
            <Link href="">
              ...
              <div className="dropdown">
                ...
                >
                  <FiShoppingCart
                    className={`${styles.shoppingCart} mt-5 p-0 ms-1`}
                  />
                </button>
                <ul className="dropdown-menu">
                  <li>
                    <Link href="/testcart">
                      <div className="dropdown-item">商品購物車</div>
                    </Link>
                  </li>
                  <li>
                    <Link href="/order">
